...
import img01 from "../assets/slider-img/car-e1.jpg";
import img02 from "../assets/slider-img/car-e2.jpg";
import img03 from "../assets/slider-img/car-e3.jpg";

const blogData = [
  {
    id: 1,
    title: "Trai nghiệm bảo hành tận nơi rất tốt",
    author: "Muhib",
    date: "12 Dec, 2020",
    time: "9pm",
    imgUrl: img01,
    description:
      " Tôi luôn tin tưởng nhãn hàng này",
    quote:

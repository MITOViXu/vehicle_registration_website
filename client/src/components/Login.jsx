    ...
    <div className="login-container">
      ...
      <div className="find-car">
        <form class="form">
          ...
          <button className="login-button" onclick={props.searchInfo}>Search Information</button>
        </form>
      </div>
      ...
      <div className="information-car">
          <div class="form-group">
            ...
            <input type="text" id="1" value={props.veicleOwner} readOnly />
          </div>
          <div class="form-group">
            <label for="name">Biển số xe</label>
            <input type="text" id="2" value={props.numberPlate} readOnly />
          </div>
          <div class="form-group">
            <label for="name">Năm sản xuất</label>
            <input type="text" id="3" value={props.yearManufac} readOnly />
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" id="9" value={props.modelCode} readOnly />
          </div>
          <div class="form-group">
            <label for="name">Số khung</label>
            <input type="text" id="10" value={props.chassicNum} readOnly />
          </div>
          <div class="form-group">
            <label for="name">Niêm Hạn sử dụng</label>
            <input type="text" id="4" value={props.lifeLimit} readOnly />
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" id="6" value={props.inspectValid} readOnly />
          </div>
      </div>

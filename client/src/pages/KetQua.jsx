          ...
          <div className="single-input">
            <div>
              ...
              <input
                ...
                onChange={(e) => handleFormFieldChange("cccd", e)}
              />
            </div>
            <div className="single-input">
              ...
              <input
                ...
                onChange={(e) => handleFormFieldChange("numberPlate", e)}
              />
            </div>
            <div className="single-input">
              ...
              <input
                ...
                onChange={(e) => handleFormFieldChange("yaerManufac", e)}
              />
            </div>
          </div>
          <div className="single-input">
            <div>
              ...
              <input
                ...
                onChange={(e) => handleFormFieldChange("lifetimeLimit", e)}
              />
            </div>
            <div className="single-input">
              ...
              <input
                ...
                onChange={(e) => handleFormFieldChange("insepectionReportN", e)}
              />
            </div>
            <div className="single-input">
              ...
              <input
                ...
                onChange={(e) =>
                  handleFormFieldChange("insepectionValidUntil", e)
                }
              />
            </div>
          </div>
          <div className="single-input">
            <div>
              ...
              <input
                ...
                onChange={(e) => handleFormFieldChange("typeOf", e)}
              />
            </div>
            <div className="single-input">
              ...
              <input
                ...
                onChange={(e) => handleFormFieldChange("mark", e)}
              />
            </div>
            <div className="single-input">
              ...
              <input
                ...
                step="0.1"
                placeholder={"Số loại"}
                onChange={(e) => handleFormFieldChange("modelCode", e)}
              />
            </div>
          </div>
          <div className="single-input">
            ...
            <input
              ...
              onChange={(e) => handleFormFieldChange("chassicNum", e)}
            />
          </div>
=======
    const handleFormFieldChange = (fieldName, e) => {
...
>>>>>>> 64f02d675a2fb321e192798fb07603e93f892810
        </div>
      </form>
    </div>
  )
